      ...
      <div className="about-intro">
        ...
        <div className="about-introPic"> 
            <a href="https://www.microsoft.com/en-us/?spl=1">
                ...
                className="about-introImg"/>
              </a>
            <p className="about-introTitle">Anthony Sokry was Here, Lorem Lorem Lorem</p>
          </div>

          <hr className="about-introLine"></hr>
          <p className="about-introCadre">
        The Cadre Mentorship Program is an academic leadership program that helps Digital Media Arts students thrive in thier careers at San Jose State University and beyond.
          ...
          <div className="about-introBtn">
              <p className="about-introConduct"> CADRE MENTORSHIP CODE OF CONDUCT</p>
            </div>  
